...
def take_role_based_screenshots():
    ...
    roles_config = {
        "admin": {
            "user": "admin",
            "pass": "admin",
            "pages": ["dashboard", "devices", "groups", "teams", "rules", "personnel", "profile", "settings", "channels"]
        },
        "manager": {
            "user": "manager",
            "pass": "manager",
            "pages": ["dashboard", "devices", "groups", "teams", "rules", "personnel", "profile"]
        },
        "member": {
            "user": "member",
            "pass": "member",
            "pages": ["dashboard", "devices", "groups", "rules", "profile"]
        }
    }
